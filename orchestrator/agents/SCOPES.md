...
| `multi_agent_consensus` | M6.0 → M6.0b | **ACTIVE** | **30/30** ✅ v1.0.0 | Sintetiza N perspectives (ya producidas) sobre una decisión high-stakes. Output: agreement_score, consensus_view, dissenting_views, key_tradeoffs, final_recommendation. R11-compliant: NO invoca otros agentes — recibe perspectives y las sintetiza con schema fijo. POST /api/v1/consensus/analyze. |
